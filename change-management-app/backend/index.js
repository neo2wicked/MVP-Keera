...
app.use(cors({
  origin: ['http://localhost:3000', 'https://your-vercel-app.vercel.app'], // Allow your frontend origins
...
app.use((req, res, next) => {
  ...
  res.header('Access-Control-Allow-Origin', req.headers.origin); // Allow only your frontend origin
